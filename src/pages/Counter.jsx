  ...
  return (
    <div className="counter-container">
      ...
      <div className="how-it-works">
        ...
        <p>When you click a button above, here's what happens in Redux:</p>
        <ol>
          <li>
            <strong>Action Dispatch:</strong> <code>dispatch(increment())</code>{" "}
            sends an action object to the store
          </li>
          <li>
            <strong>Reducer Processing:</strong> The counterSlice reducer
            receives the action and updates the state
          </li>
          <li>
            <strong>State Update:</strong> The store updates with the new state
            value
          </li>
          <li>
            <strong>Component Re-render:</strong> <code>useSelector</code>{" "}
            detects the change and re-renders this component
          </li>
          <li>
            <strong>UI Update:</strong> The new count value appears on screen
          </li>
        </ol>
...
if (!isNaN(amount) && amount !== 0) {
  dispatch(incrementByAmount(amount))
      ...
      <div className="history-section">
        ...
        <p>
          This shows how Redux can manage complex state like arrays and objects:
        </p>
...
history.slice(-10).reverse().map(...)`}
      ...
      <div className="educational-notes">
        ...
        <ul>
          <li>
            <strong>useSelector:</strong> Reads state from Redux store.
            Component re-renders when selected state changes.
          </li>
          <li>
            <strong>useDispatch:</strong> Gets dispatch function to send actions
            to the store.
          </li>
          <li>
          ...
          <li>
            <strong>Payload:</strong> Data passed with actions (e.g.,{" "}
            <code>incrementByAmount(5)</code>).
          </li>
          <li>
            <strong>Immutability:</strong> Redux Toolkit uses Immer, so we can
            write "mutating" logic that's actually immutable.
          </li>
          <li>
            <strong>State Structure:</strong> Our counter has <code>value</code>
            , <code>incrementAmount</code>, and <code>history</code> properties.
          </li>
          <li>
            <strong>Selectors:</strong> Functions that extract specific pieces
            of state (e.g., <code>selectCount</code>).
          </li>
        </ul>
        ...
        <ul>
          <li>
            <strong>Separate Concerns:</strong> Redux for global state, local
            state for UI-specific data.
          </li>
          <li>
            <strong>Input Validation:</strong> Validate data before dispatching
            actions.
          </li>
          <li>
            <strong>Descriptive Actions:</strong> Use clear action names like{" "}
            <code>incrementByAmount</code>.
          </li>
          <li>
            <strong>Selector Functions:</strong> Use <code>selectCount</code>{" "}
            instead of <code>state =&gt; state.counter.value</code>.
          </li>
          <li>
            <strong>History Tracking:</strong> Store action history for
        ...
        <ul>
          <li>
            Open Redux DevTools in your browser to see actions being dispatched
          </li>
          <li>
            Try clicking buttons rapidly to see how Redux handles multiple state
            updates
          </li>
          <li>
            Change the increment amount and see how it affects the "Add X"
            button
          </li>
          <li>
            Notice how the history updates in real-time as you perform actions
          </li>
        </ul>
      </div>
      ...
      <div className="how-it-works">
        ...
        <p>
          Redux DevTools is a powerful browser extension that lets you inspect
          and debug Redux state changes.
        </p>
        <ol>
          <li>Install the Redux DevTools Extension in your browser</li>
          <li>Open Developer Tools (F12) and look for the "Redux" tab</li>
          <li>
            Click buttons in this counter and watch the actions appear in
            DevTools
          </li>
          <li>
            You can "time travel" by clicking on previous actions to see how
            state looked
          </li>
